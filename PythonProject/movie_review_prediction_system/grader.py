...
-----------------------------
Milestone 4 answer:
numEpochs越大(training越多次)，train error和validation error越來越小，但
但當numEpochs超過70後，validation error卻緩慢上升，此為overfitting的情況:
training太用力，讓model在預測時失準
...
# overfitting的情況
# 在train error上extractCharacterFeature表現很好，但預測上的validation error表現卻沒有extractWordFeatures來得好
# 要reduce feature 在預測的表現才會更好
############################################################
